...
#define MATRIX_AXIS1(t, i) ((t).data + i * (t).cols)
...
void mat_u8_mean(f64* mean, mat_u8 dataset, u32 sample_size, u32 num_samples);
void mat_u8_variance(f64* variance, mat_u8 dataset, u32 sample_size, u32 num_samples, f64* mean);
